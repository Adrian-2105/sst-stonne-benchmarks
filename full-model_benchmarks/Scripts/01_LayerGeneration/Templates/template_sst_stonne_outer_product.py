...
comp_stonne.addParams({
    ...
    "rowpointer_matrix_a_init" : "outerproduct_gemm_rowpointerA.in",
    "colpointer_matrix_a_init" : "outerproduct_gemm_colpointerA.in",
    "rowpointer_matrix_b_init" : "outerproduct_gemm_rowpointerB.in",
    "colpointer_matrix_b_init" : "outerproduct_gemm_colpointerB.in",
