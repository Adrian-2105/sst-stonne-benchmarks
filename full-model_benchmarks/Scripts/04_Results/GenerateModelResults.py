...
class DataflowResult:
    ...
    def __init__(self, layer_dir, dataflow):
...
if __name__ == '__main__':
    ...
    with open(OUTPUT_FILE_FULLPATH, 'w') as f:
        ...
        print(';'.join([
            ...
            # cache statistics
            'cache_B_hits inner_product_m',
            'cache_B_misses inner_product_m',
            'cache_B_total_accesses inner_product_m',
            'cache_B_hit_rate inner_product_m',
            'cache_B_hits inner_product_n',
            'cache_B_misses inner_product_n',
            'cache_B_total_accesses inner_product_n',
            'cache_B_hit_rate inner_product_n',
            'cache_B_hits outer_product_m',
            'cache_B_misses outer_product_m',
            'cache_B_total_accesses outer_product_m',
            'cache_B_hit_rate outer_product_m',
            'cache_B_hits outer_product_n',
            'cache_B_misses outer_product_n',
            'cache_B_total_accesses outer_product_n',
            'cache_B_hit_rate outer_product_n',
            'cache_B_hits gustavsons_m',
            'cache_B_misses gustavsons_m',
            'cache_B_total_accesses gustavsons_m',
            'cache_B_hit_rate gustavsons_m',
            'cache_B_hits gustavsons_n',
            'cache_B_misses gustavsons_n',
            'cache_B_total_accesses gustavsons_n',
            'cache_B_hit_rate gustavsons_n',

            # memory statistics
            'N_cycles_multiplying inner_product_m',
            'N_cycles_merging inner_product_m',
            'N_SRAM_weight_reads inner_product_m',
            'N_SRAM_input_reads inner_product_m',
            'N_SRAM_psum_reads inner_product_m',
            'N_SRAM_psum_writes inner_product_m',
            'N_DRAM_psum_writes inner_product_m',
            'N_cycles_multiplying inner_product_n',
            'N_cycles_merging inner_product_n',
            'N_SRAM_weight_reads inner_product_n',
            'N_SRAM_input_reads inner_product_n',
            'N_SRAM_psum_reads inner_product_n',
            'N_SRAM_psum_writes inner_product_n',
            'N_DRAM_psum_writes inner_product_n',
            'N_cycles_multiplying outer_product_m',
            'N_cycles_merging outer_product_m',
            'N_SRAM_weight_reads outer_product_m',
            'N_SRAM_input_reads outer_product_m',
            'N_SRAM_psum_reads outer_product_m',
            'N_SRAM_psum_writes outer_product_m',
            'N_DRAM_psum_writes outer_product_m',
            'N_cycles_multiplying outer_product_n',
            'N_cycles_merging outer_product_n',
            'N_SRAM_weight_reads outer_product_n',
            'N_SRAM_input_reads outer_product_n',
            'N_SRAM_psum_reads outer_product_n',
            'N_SRAM_psum_writes outer_product_n',
            'N_DRAM_psum_writes outer_product_n',
            'N_cycles_multiplying gustavsons_m',
            'N_cycles_merging gustavsons_m',
            'N_SRAM_weight_reads gustavsons_m',
            'N_SRAM_input_reads gustavsons_m',
            'N_SRAM_psum_reads gustavsons_m',
            'N_SRAM_psum_writes gustavsons_m',
            'N_DRAM_psum_writes gustavsons_m',
            'N_cycles_multiplying gustavsons_n',
            'N_cycles_merging gustavsons_n',
            'N_SRAM_weight_reads gustavsons_n',
            'N_SRAM_input_reads gustavsons_n',
            'N_SRAM_psum_reads gustavsons_n',
            'N_SRAM_psum_writes gustavsons_n',
            'N_DRAM_psum_writes gustavsons_n',
        ]), file=f)
