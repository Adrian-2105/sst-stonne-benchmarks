...
comp_stonne.addParams({
    ...
    "GEMM_N" : 2,
    "GEMM_M" : 4,
    "rowpointer_matrix_a_init" : "A_csc_rowpointer.in",
    "colpointer_matrix_a_init" : "A_csc_colpointer.in",
    ...
    "matrix_c_dram_address" : 16 + 12,
    "mem_matrix_c_file_name" : "result_AB.out"
