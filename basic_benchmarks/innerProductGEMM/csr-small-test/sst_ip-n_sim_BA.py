...
comp_stonne.addParams({
    ...
    "kernelOperation" : "innerProductGEMM",
    "GEMM_M" : 2,
    "GEMM_K" : 3,
    "GEMM_N" : 3,
    "rowpointer_matrix_a_init" : "B_csc_rowpointer.in",
    "colpointer_matrix_a_init" : "B_csc_colpointer.in",
    "rowpointer_matrix_b_init" : "A_csr_rowpointer.in",
    "colpointer_matrix_b_init" : "A_csr_colpointer.in",
    "mem_init" : "B-col_A-row_mem.ini",
    "matrix_a_dram_address" : 0,
    "matrix_b_dram_address" : 12,
    "matrix_c_dram_address" : 28,
    "mem_matrix_c_file_name" : "result_ip-n_BA.out"
