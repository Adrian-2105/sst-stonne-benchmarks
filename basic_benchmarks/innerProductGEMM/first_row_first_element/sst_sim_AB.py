...
comp_stonne.addParams({
    ...
    "rowpointer_matrix_b_init" : "B_csc_rowpointer.in",
    "colpointer_matrix_b_init" : "B_csc_colpointer.in",
    "mem_init" : "A-row_B-col_mem.ini",
    "matrix_a_dram_address" : 0,
    "matrix_b_dram_address" : 28,
    "matrix_c_dram_address" : 12 + 28,
    "mem_matrix_c_file_name" : "result_ip-m_AB.out"
